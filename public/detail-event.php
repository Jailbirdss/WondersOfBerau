...
$gallery = get_gallery($id, 'event');

$tips_list = !empty($event['tips']) ? explode('|', $event['tips']) : [];
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Detail Event: <?php echo htmlspecialchars($event['nama']); ?> - Wonders of Berau</title>
...
<body>
    ...
    <main>
        <section class="detail-hero"
            style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('<?php echo htmlspecialchars($event['gambar_utama']); ?>');">
            <div class="container">
                <h1 class="page-title"><?php echo htmlspecialchars($event['nama']); ?></h1>
                <p class="section-subtitle" style="color: #fff;"><?php echo htmlspecialchars($event['deskripsi']); ?>
                </p>
            </div>
        </section>
        ...
        <section class="container section">
            <div class="detail-grid">
                <div class="detail-content">
                    <h2 class="section-title" style="text-align: left; font-size: 2rem;">Deskripsi Event</h2>
                    <p><?php echo nl2br(htmlspecialchars($event['deskripsi_lengkap'])); ?></p>
                    <button class="btn-secondary share-btn" data-title="<?php echo htmlspecialchars($event['nama']); ?>"
                        data-text="Yuk ikutan event ini!" data-url="detail-event.php?id=<?php echo $id; ?>"
        ...
        <section class="container section info-section">
            <h2 class="section-title">Informasi Event</h2>
            <div class="info-grid">
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <h3>Jam Pelaksanaan</h3>
                    <p><?php echo htmlspecialchars($event['jam_pelaksanaan']); ?></p>
                </div>
                <div class="info-item">
                ...
                <div class="info-item">
                    ...
                    <h3>Kontak</h3>
                    <p><?php echo htmlspecialchars($event['kontak']); ?></p>
                </div>
                <div></div>
                <div class="info-item">
                    <i class="fa-solid fa-user-tie"></i>
                    <h3>Penyelenggara</h3>
                    <p><?php echo htmlspecialchars($event['penyelenggara']); ?></p>
                </div>
            </div>
        </section>
        ...
        <?php if (!empty($event['maps_embed'])): ?>
            <section class="container section">
                ...
                <div class="map-container">
                    <iframe src="<?php echo htmlspecialchars($event['maps_embed']); ?>" width="100%" height="450"
