...
$gallery = get_gallery($id, 'kuliner');

$tempat_list = !empty($kuliner['tempat_rekomendasi']) ? explode('|', $kuliner['tempat_rekomendasi']) : [];
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Detail Kuliner: <?php echo htmlspecialchars($kuliner['nama']); ?> - Wonders of Berau</title>
...
<body>
    ...
    <main>
        <section class="detail-hero"
            style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('<?php echo htmlspecialchars($kuliner['gambar_utama']); ?>');">
            <div class="container">
                <h1 class="page-title"><?php echo htmlspecialchars($kuliner['nama']); ?></h1>
                <p class="section-subtitle" style="color: #fff;"><?php echo htmlspecialchars($kuliner['deskripsi']); ?>
                </p>
            </div>
        </section>
            ...
            <div class="detail-grid">
                <div class="detail-content">
                    <h2 class="section-title" style="text-align: left; font-size: 2rem;">Tentang
                        <?php echo htmlspecialchars($kuliner['nama']); ?>
                    </h2>
                    <p><?php echo nl2br(htmlspecialchars($kuliner['deskripsi_lengkap'])); ?></p>
                    <button class="btn-secondary share-btn"
                        data-title="<?php echo htmlspecialchars($kuliner['nama']); ?>"
                        data-text="Yuk cek kuliner ini!"
                        data-url="detail-kuliner.php?id=<?php echo $id; ?>"
        ...
        <section class="container section info-section">
            <h2 class="section-title">Informasi Kuliner</h2>
            <div class="info-grid">
                <div class="info-item">
                    <i class="fa-solid fa-utensils"></i>
                    <h3>Cita Rasa</h3>
                    <p><?php echo htmlspecialchars($kuliner['cita_rasa']); ?></p>
                </div>
                <div class="info-item">
                    <i class="fa-solid fa-leaf"></i>
                    <h3>Bahan Utama</h3>
                    <p><?php echo htmlspecialchars($kuliner['bahan_utama']); ?></p>
                </div>
                <div class="info-item">
                    <i class="fa-solid fa-money-bill-wave"></i>
                    <h3>Kisaran Harga</h3>
                    <p><?php echo htmlspecialchars($kuliner['harga_kisaran']); ?></p>
                </div>
            </div>
        </section>
        ...
        <?php if (!empty($tempat_list)): ?>
            <section class="container section">
                <h2 class="section-title">Rekomendasi Tempat</h2>
                <div class="rekomendasi-grid">
                    <?php
                    $icons = ['fa-store', 'fa-water', 'fa-gift'];
                    foreach ($tempat_list as $index => $tempat):
                        ...
                        <div class="rekomendasi-card">
                            ...
                            <h3><?php echo htmlspecialchars($tempat); ?></h3>
                            <p>Lokasi Rekomendasi</p>
                        </div>
                    <?php endforeach; ?>
                </div>
            </section>
