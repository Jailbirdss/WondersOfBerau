...
$gallery = get_gallery($id, 'akomodasi');
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Detail Akomodasi: <?php echo htmlspecialchars($akomodasi['nama']); ?> - Wonders of Berau</title>
...
<body>
    ...
    <main>
        <section class="detail-hero"
            style="background-image: linear-gradient(rgba(0,0,0,0.4), rgba(0,0,0,0.4)), url('<?php echo htmlspecialchars($akomodasi['gambar_utama']); ?>');">
            <div class="container">
                <h1 class="page-title"><?php echo htmlspecialchars($akomodasi['nama']); ?></h1>
                <p class="section-subtitle" style="color: #fff;">
                    <?php echo htmlspecialchars($akomodasi['deskripsi']); ?>
                </p>
            </div>
        </section>
        ...
        <section class="container section">
            <div class="detail-grid">
                <div class="detail-content">
                    <h2 class="section-title" style="text-align: left; font-size: 2rem;">Tentang
                        <?php echo ucfirst($akomodasi['tipe']); ?>
                    </h2>
                    <p><?php echo nl2br(htmlspecialchars($akomodasi['deskripsi_lengkap'])); ?></p>
                    <button class="btn-secondary share-btn"
                        data-title="<?php echo htmlspecialchars($akomodasi['nama']); ?>"
                        data-text="Yuk cek akomodasi ini!"
                        data-url="detail-akomodasi.php?id=<?php echo $id; ?>"
        ...
        <section class="container section info-section">
            <h2 class="section-title">Informasi & Fasilitas</h2>
            <div class="info-grid">
                <div class="info-item">
                    <i class="fa-solid fa-money-bill-wave"></i>
                    <h3>Rentang Harga</h3>
                    <p><?php echo htmlspecialchars($akomodasi['harga_mulai']); ?></p>
                </div>
                <div class="info-item">
                    <i class="fa-solid fa-wifi"></i>
                    <h3>Fasilitas Utama</h3>
                    <p><?php echo htmlspecialchars($akomodasi['fasilitas']); ?></p>
                </div>
                <div class="info-item">
                    <i class="fa-solid fa-bed"></i>
                    <h3>Tipe Kamar</h3>
                    <p><?php echo htmlspecialchars($akomodasi['tipe_kamar']); ?></p>
                </div>
            </div>
        </section>
        ...
        <section class="container section">
            ...
            <div class="contact-info">
                <p><i class="fa-solid fa-phone"></i> <strong>Telepon:</strong>
                    <?php echo htmlspecialchars($akomodasi['telepon']); ?></p>
                <p><i class="fa-solid fa-envelope"></i> <strong>Email:</strong>
                    <?php echo htmlspecialchars($akomodasi['email']); ?></p>
                <?php if (!empty($akomodasi['website'])): ?>
                    <p><i class="fa-solid fa-globe"></i> <strong>Website:</strong>
                        <?php echo htmlspecialchars($akomodasi['website']); ?></p>
                <?php endif; ?>
            </div>
        </section>

        <?php if (!empty($akomodasi['maps_embed'])): ?>
            <section class="container section">
                <h2 class="section-title">Lokasi <?php echo ucfirst($akomodasi['tipe']); ?></h2>
                <div class="map-container">
                    <iframe src="<?php echo htmlspecialchars($akomodasi['maps_embed']); ?>" width="100%" height="450"
