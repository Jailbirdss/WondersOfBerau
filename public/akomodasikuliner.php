...
$akomodasi_list = get_akomodasi();

$kuliner_list = get_kuliner();
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Akomodasi & Kuliner - Wonders of Berau</title>
...
<body>
    ...
    <header>
        <nav class="navbar">
            ...
            <ul class="nav-menu">
                ...
                <li class="nav-item"><a href="akomodasikuliner.php" class="nav-link active">Akomodasi & Kuliner</a></li>
    ...
    <main>
        <section id="akomodasi" class="section page-header">
            <div class="container">
                <h1 class="page-title">Akomodasi & Kuliner</h1>
                <p class="section-subtitle">Temukan tempat menginap yang nyaman dan cicipi kuliner lokal yang menggugah
                    selera.</p>
                <div class="tabs">
