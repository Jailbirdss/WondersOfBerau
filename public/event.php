...
<head>
    ...
    <title>Kalender Event - Wonders of Berau</title>
...
<body>
    ...
    <main>
        <section id="event-list" class="section page-header">
            <div class="container">
                <h1 class="page-title">Kalender Acara & Festival</h1>
                <p class="section-subtitle">Jangan lewatkan berbagai acara budaya dan festival menarik yang
                    diselenggarakan di Berau sepanjang tahun.</p>
                <div class="card-grid">
                        ...
                        <div class="card">
                            ...
                            <div class="card-content">
                                <div class="event-date-badge">
                                    <span class="month"><?php echo strtoupper($event['bulan']); ?></span>
                                    <span class="day"><?php echo $event['hari']; ?></span>
                                </div>
                                ...
                                <a href="detail-event.php?id=<?php echo $event['id']; ?>" class="btn-secondary">Lihat
                                    Event</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
