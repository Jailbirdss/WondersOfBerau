...
if (!empty($keyword)) {
    ...
    $total_results = count($results['destinasi']) + count($results['akomodasi']) + count($results['kuliner']) + count($results['events']);
}
?>
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Hasil Pencarian: <?php echo htmlspecialchars($keyword); ?> - Wonders of Berau</title>
    ...
    <main>
        <section class="page-header">
            <div class="container">
                ...
                <p class="page-subtitle">Menampilkan hasil untuk
                    "<strong><?php echo htmlspecialchars($keyword); ?></strong>"</p>
                <?php if (!empty($keyword)): ?>
                    <p class="search-count"><?php echo $total_results; ?> hasil ditemukan</p>
                <?php endif; ?>
            </div>
        </section>
            ...
            <section class="container section">
                <div class="empty-state">
                    <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M60 60L85 85" stroke="currentColor" stroke-width="4" stroke-linecap="round" />
                    </svg>
                    <h2>Cari Sesuatu</h2>
                    <p>Gunakan kolom pencarian di atas untuk menemukan destinasi, akomodasi, kuliner, atau event yang Anda
                        cari.</p>
                </div>
            </section>
            ...
            <section class="container section">
                <div class="empty-state">
                    <svg width="100" height="100" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <circle cx="40" cy="40" r="30" stroke="currentColor" stroke-width="4" />
                        <path d="M60 60L85 85" stroke="currentColor" stroke-width="4" stroke-linecap="round" />
                        <path d="M30 35L50 45M50 35L30 45" stroke="currentColor" stroke-width="4" stroke-linecap="round" />
                    </svg>
                    <h2>Tidak Ada Hasil</h2>
                    <p>Maaf, tidak ada hasil yang ditemukan untuk
                        "<strong><?php echo htmlspecialchars($keyword); ?></strong>"</p>
        ...
        <?php else: ?>
            ...
            <?php if (count($results['destinasi']) > 0): ?>
                <section class="container section">
                    <h2 class="section-title">Destinasi (<?php echo count($results['destinasi']); ?>)</h2>
                    <div class="card-grid">
                        <?php foreach ($results['destinasi'] as $destinasi): ?>
                            <div class="card">
            ...
            <?php if (count($results['akomodasi']) > 0): ?>
                <section class="container section">
                    <h2 class="section-title">Akomodasi (<?php echo count($results['akomodasi']); ?>)</h2>
                    <div class="card-grid">
                        <?php foreach ($results['akomodasi'] as $akomodasi): ?>
                            <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <a href="detail-akomodasi.php?id=<?php echo $akomodasi['id']; ?>" class="btn-secondary">Lihat
                                    Detail</a>
                            </div>
                        </div>
                    <?php endforeach; ?>
            ...
            <?php if (count($results['kuliner']) > 0): ?>
                <section class="container section">
                    <h2 class="section-title">Kuliner & UMKM (<?php echo count($results['kuliner']); ?>)</h2>
                    <div class="card-grid">
                        <?php foreach ($results['kuliner'] as $kuliner): ?>
                            <div class="card">
            ...
            <?php if (count($results['events']) > 0): ?>
                <section class="container section">
                    <h2 class="section-title">Event (<?php echo count($results['events']); ?>)</h2>
                    <div class="card-grid">
                        <?php foreach ($results['events'] as $event): ?>
                            <div class="card">
                                ...
                                <div class="stars-inline" aria-hidden="true">
                                    ...
                                    <a href="detail-event.php?id=<?php echo $event['id']; ?>" class="btn-secondary">Lihat Detail</a>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
